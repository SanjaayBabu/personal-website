...
<Callout>
**Key idea:** Nordic countries emphasize egalitarianism and trust.
</Callout>

<Aside>
This is an aside note that should be visually separate from the main body.
</Aside>

Here is an inline tip: <Tip>Remember to check local customs.</Tip>
